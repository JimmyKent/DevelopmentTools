...
public class ReflectHelper {
    ...
    private static Object invoke(Class<?> objClass, Object obj, String methodName, Object[] params) throws Exception {
        if (params == null || params.length == 0) {
            ...
            Method method = objClass.getDeclaredMethod(methodName, getParamsTypes(params));
            method.setAccessible(true);
    ...
    public static Object invoke(Class<?> objClass, Object obj, String methodName, Class<?> paramsType, Object param) throws Exception {
        Method method = objClass.getDeclaredMethod(methodName, paramsType);
        method.setAccessible(true);
