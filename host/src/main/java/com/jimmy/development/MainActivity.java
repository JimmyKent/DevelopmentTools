...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_test_img_plugin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                RePlugin.startActivity(MainActivity.this, RePlugin.createIntent("com.jimmy.development.plugin.imgplugin", "com.jimmy.development.plugin.imgplugin.MainActivity"));
